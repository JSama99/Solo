...
R=os.path.dirname(os.path.abspath(__file__));bpy.ops.wm.open_mainfile(filepath=R+'/../../Phase6/StartupRow/Blender/Atlantis_Phase6_Masterplan.blend');bpy.context.view_layer.update();s=bpy.context.scene
rows=[]
for o in s.objects:
 if o.name.startswith(('Founder','Progression_Startup','AtlantisBridge_Main')):
