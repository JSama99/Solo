...
R=os.path.dirname(os.path.abspath(__file__));A=R+'/Flashpoint'
def sig(o):
...
bpy.ops.wm.open_mainfile(filepath=A+'/Blender/Before_Flashpoint.blend');base={o.name:sig(o) for o in bpy.context.scene.objects}
...
for o in bpy.data.collections['Flashpoint_Blockout'].objects:
...
for n in ['Founder_To_City','TheSpire_StartupSightline','StartupRow_Flashpoint','Media_RivalSkyline','TechCore_Rivals_Aerial','UnicornHeights_View']:
