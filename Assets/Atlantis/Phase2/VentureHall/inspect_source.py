...
bpy.ops.import_scene.gltf(filepath=R+'/Source/VentureHall_Higgsfield_Raw.glb')
...
d=bpy.data.cameras.new('Source_Review');o=bpy.data.objects.new('Source_Review',d);scene.collection.objects.link(o);o.location=(200,-270,160);aim(o,(0,0,50));d.type='ORTHO';d.ortho_scale=230;scene.camera=o
