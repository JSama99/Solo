...
Venture objectives are evaluated in the shared end-of-venture path before each mode resolves, including terminal ventures. Sprint-objective completions and venture-objective completions use separate counters. Checkpoints use a compatibility decoder so saves written before their Build 24 fields existed remain loadable.
